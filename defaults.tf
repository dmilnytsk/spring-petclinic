...
resource "aws_default_route_table" "defaultroute" {
  default_route_table_id = module.network.aws_vpc_lamp_vpc_default_route_table_id
...
resource "aws_default_network_acl" "defaultnacl" {
  default_network_acl_id = module.network.aws_vpc_lamp_vpc_default_network_acl_id
